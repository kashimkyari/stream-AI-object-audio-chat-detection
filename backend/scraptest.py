...
#   GNU nano 8.3                            /etc/systemd/system/.#gunicorn.servicecc76f0ae91d75cfd                                       
# [Unit]
...
# ExecStart=/opt/pytorch/bin/gunicorn --workers 6 --bind 127.0.0.1:5000 --certfile /home/ec2-user/certs/fullchain2.pem --keyfile /home/e>
